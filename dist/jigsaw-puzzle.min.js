...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=exports.puzzle=void 0;var e=require("./utils/dom.js"),i=require("./utils/pipe.js"),a=require("./utils/tap.js"),t=require("./utils/event-listeners.js"),s=require("./lib/make-canvas.js"),p=require("./lib/load-image.js"),r=require("./lib/make-puzzle.js"),n=require("./lib/make-pieces.js"),u=require("./lib/shuffle.js"),l=require("./lib/paint.js"),o=require("./lib/activate.js"),c=require("./lib/deactivate.js"),v=require("./lib/move.js"),m=require("./lib/snap.js"),d=require("./lib/status.js"),j=require("./lib/gather.js"),q=require("./lib/clone.js");const b=async({element:b,restore:z={},image:g="",pieces:f={x:6,y:4},attraction:w=20,size:C=.8,draggable:h=!1,onComplete:k=(()=>{}),onChange:x=(()=>{})})=>{const y="string"==typeof b?(0,e.$)(b):b;if(!y)return void console.warn(`Couldn't find element: ${b}`);const P=(0,s.makeCanvas)(y),S=z.image||await(0,p.loadImage)(g),A=()=>z.puzzle||(0,r.makePuzzle)(f,S,w,y,C,h,k),N=z.pieces||(0,n.makePieces)(A()),$=(0,a.tap)((0,i.pipe)(q.clone,x)),_=()=>({image:S,canvas:P,pieces:N,puzzle:A()});let G=_();G=z.puzzle?(0,i.pipe)(l.paint)(G):(0,i.pipe)(u.shuffle,l.paint)(G);const I=[(0,t.event)(window).resize(e=>G=(0,i.pipe)(s.updCanvas,j.gather,l.paint)(G)),(0,t.event)(window).scroll(e=>G=(0,i.pipe)(s.updCanvas)(G)),(0,t.event)(G.canvas).mousedown(e=>G=(0,i.pipe)((0,o.activate)(e),l.paint)(G)),(0,t.event)(G.canvas).mousemove(e=>G=(0,i.pipe)((0,v.move)(e),l.paint)(G)),(0,t.event)(document.body).mouseup(e=>G=(0,i.pipe)(m.snap,c.deactivate,d.status,l.paint,$)(G))];return{newGame:()=>G=(0,i.pipe)(u.shuffle,l.paint)(_()),getState:()=>(0,q.clone)(G),setState:e=>G=(0,i.pipe)(q.clone,l.paint)(e),update:()=>G=(0,i.pipe)(s.updCanvas,l.paint)(G),destroy:()=>{"CANVAS"!==b.tagName&&G.canvas.element.remove(),G=null,I.map(e=>e.remove())}}};exports.puzzle=b;var z=b;exports.default=z;
