...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.event=void 0;const e=(e,o,s)=>{const t=s;return o.addEventListener(e,s),{remove:()=>o.removeEventListener(e,t)}},o=o=>({scroll:o=>e("scroll",window,o),resize:o=>e("resize",window,o),click:s=>e("click",o.element,s),mousedown:s=>e("mousedown",o.element,s),mousemove:s=>e("mousemove",o.element,s),mouseup:o=>e("mouseup",document.body,o)});exports.event=o;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.makePuzzle=void 0;const e=(e,t,i,o,h,d,a)=>{const{width:r,height:s}=getComputedStyle(o),c=t.width<t.height,l=window.devicePixelRatio,n=parseInt([c?s:r],0)/t[c?"height":"width"];return{timeStamp:Date.now(),done:!1,cols:e.x,rows:e.y,width:t.width*n*l,height:t.height*n*l,attraction:i,scale:n,occupy:h,draggable:d,onComplete:a}};exports.makePuzzle=e;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.shuffle=void 0;var e=require("./../utils/random.js");const s=s=>({...s,pieces:s.pieces.map((i,t)=>({...i,connections:[],curPos:{x:(0,e.random)(t)*(s.canvas.width-s.pieces[0].width),y:(0,e.random)(t+123)*(s.canvas.height-s.pieces[0].height)}}))});exports.shuffle=s;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.paintPiece=void 0;var e=require("./../utils/sides.js");const t=t=>a=>{const{image:s}=t.image,{ctx:i,DPI:r}=t.canvas,{scale:h,occupy:c}=t.puzzle,n=Math.max(a.width,a.height);i.save(),i.beginPath(),i.translate(a.curPos.x,a.curPos.y+a.height),e.allSides.forEach(e=>{o(i,a.shapes[e],{x:"top"===e||"bottom"===e?-a.height:-a.width,y:"top"===e||"bottom"===e?a.width:a.height})}),i.closePath(),i.clip(),i.drawImage(s,(a.orgPos.x-n)/h/r/c,(a.orgPos.y-n)/h/r/c,(a.width+2*n)/h/r/c,(a.height+2*n)/h/r/c,a.curPos.x/t.canvas.width-n,a.curPos.y/t.canvas.height-n-a.height,a.width+2*n,a.height+2*n),i.restore();const l=!t.puzzle.done&&(a.active||a.alsoActive);return i.shadowColor=l?"rgba(100, 100, 100, 1)":"rgba(50, 50, 50, 1)",i.strokeStyle=l?"rgba(225, 225, 225, 1)":"rgba(220, 220, 220, 1)",i.shadowBlur=l?2:1,i.lineWidth=l?2:1,i.shadowOffsetX=i.shadowOffsetY=-1,i.lineCap="round",i.lineJoin="round",i.stroke(),a};function o(e,t,o){e.translate(0,o.x),"flat"===t?e.lineTo(o.y,0):t.forEach(t=>{e.bezierCurveTo(t.cx1,t.cy1,t.cx2,t.cy2,t.ex,t.ey)}),e.rotate(Math.PI/2)}exports.paintPiece=t;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.paint=void 0;var e=require("./../utils/array-helpers.js"),a=require("./paint-piece.js"),s=require("./clear-canvas.js");const r=r=>({...r,canvas:{...r.canvas,ctx:(0,s.clearCanvas)(r,r.canvas.ctx)},pieces:(0,e.map)((0,a.paintPiece)(r))(r.pieces)});exports.paint=r;
...
},{"./../utils/array-helpers.js":"lzTd","./../utils/object-helpers.js":"E8ee","./../utils/run-if.js":"O7JW","./../utils/pipe.js":"ZnGg","./../utils/is-under-cursor.js":"H5q6"}],"d6jk":[function(require,module,exports) {
...
},{}],"FLWX":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.setCursor=exports.getCursor=void 0;var r=require("./../utils/is-under-cursor.js");const e=e=>s=>{const o=s.pieces.find(o=>(0,r.isUnderCursor)(s,o,e)),c=s.pieces.find(r=>r.active),t=s.pieces.every(r=>r.active);!c||t?!o||c?s.puzzle.draggable&&(s.canvas.cursor="move"):s.canvas.cursor="grab":s.canvas.cursor="grabbing"};exports.getCursor=e;const s=r=>{r.canvas.element.style.cursor=r.canvas.cursor};exports.setCursor=s;
},{"./../utils/is-under-cursor.js":"H5q6"}],"Focm":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=exports.puzzle=void 0;var e=require("./utils/dom.js"),t=require("./utils/pipe.js"),i=require("./utils/tap.js"),a=require("./utils/event-listeners.js"),s=require("./lib/make-canvas.js"),r=require("./lib/load-image.js"),p=require("./lib/make-puzzle.js"),n=require("./lib/make-pieces.js"),u=require("./lib/shuffle.js"),o=require("./lib/paint.js"),l=require("./lib/activate.js"),c=require("./lib/deactivate.js"),v=require("./lib/move.js"),m=require("./lib/snap.js"),d=require("./lib/status.js"),j=require("./lib/gather.js"),q=require("./lib/clone.js"),b=require("./lib/cursor.js");const g=async({element:g,restore:z={},image:f="",pieces:C={x:6,y:4},attraction:w=20,size:y=.8,draggable:h=!1,onComplete:k=(()=>{}),onChange:x=(()=>{})})=>{const P="string"==typeof g?(0,e.$)(g):g;if(!P)return void console.warn(`Couldn't find element: ${g}`);const S=(0,s.makeCanvas)(P),A=z.image||await(0,r.loadImage)(f),N=()=>z.puzzle||(0,p.makePuzzle)(C,A,w,P,y,h,k),$=z.pieces||(0,n.makePieces)(N()),_="function"==typeof x&&(0,i.tap)((0,t.pipe)(q.clone,x)),G=()=>({image:A,canvas:S,pieces:$,puzzle:N()});let I=G();I=z.puzzle?(0,t.pipe)(o.paint)(I):(0,t.pipe)(u.shuffle,o.paint)(I);const M=[(0,a.event)(window).resize(e=>I=(0,t.pipe)(s.updCanvas,j.gather,o.paint)(I)),(0,a.event)(window).scroll(e=>I=(0,t.pipe)(s.updCanvas)(I)),(0,a.event)(I.canvas).mousedown(e=>I=(0,t.pipe)((0,l.activate)(e),(0,i.tap)((0,b.getCursor)(e)),o.paint,(0,i.tap)(b.setCursor))(I)),(0,a.event)(I.canvas).mousemove(e=>I=(0,t.pipe)((0,i.tap)((0,b.getCursor)(e)),(0,v.move)(e),o.paint,(0,i.tap)(b.setCursor))(I)),(0,a.event)(document.body).mouseup(e=>I=(0,t.pipe)(m.snap,c.deactivate,(0,i.tap)((0,b.getCursor)(e)),d.status,o.paint,(0,i.tap)(b.setCursor),_)(I))];return{newGame:()=>I=(0,t.pipe)(u.shuffle,o.paint)(G()),getState:()=>(0,q.clone)(I),setState:e=>I=(0,t.pipe)(q.clone,o.paint)(e),update:()=>I=(0,t.pipe)(s.updCanvas,o.paint)(I),destroy:()=>{"CANVAS"!==g.tagName&&I.canvas.element.remove(),I=null,M.map(e=>e.remove())}}};exports.puzzle=g;var z=g;exports.default=z;
},{"./utils/dom.js":"hZBy","./utils/pipe.js":"ZnGg","./utils/tap.js":"BphK","./utils/event-listeners.js":"LmCC","./lib/make-canvas.js":"p0XB","./lib/load-image.js":"Qepy","./lib/make-puzzle.js":"TZKA","./lib/make-pieces.js":"ayG8","./lib/shuffle.js":"Meu3","./lib/paint.js":"nchg","./lib/activate.js":"xNGh","./lib/deactivate.js":"d6jk","./lib/move.js":"ojCs","./lib/snap.js":"Jg52","./lib/status.js":"mXFZ","./lib/gather.js":"n5T4","./lib/clone.js":"nsMB","./lib/cursor.js":"FLWX"}]},{},["Focm"], null)